...
感谢您对 PharmaSim 项目的关注！我们欢迎任何形式的贡献。

## 如何贡献

### 报告问题

1. 查看 [Issues](https://github.com/MoKangMedical/PharmaSim/issues) 确保问题未被报告
2. 创建新的 Issue，详细描述问题
3. 包含复现步骤、期望行为和实际行为
...
- 项目 Issues：https://github.com/MoKangMedical/PharmaSim/issues
